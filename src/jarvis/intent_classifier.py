...
class IntentClassifier:
    ...
    def __init__(self) -> None:
        ...
        self.action_verbs = {
            "open", "create", "delete", "move", "copy", "start", "stop", "run", 
            "execute", "launch", "close", "save", "load", "download", "upload",
            "install", "uninstall", "restart", "shutdown", "type", "click",
            "search", "find", "list", "show", "hide", "enable", "disable",
            "connect", "disconnect", "send", "receive", "play", "pause",
            "record", "capture", "screenshot", "backup", "restore", "update",
            "upgrade", "downgrade", "mount", "unmount", "format", "clean",
            "clear", "remove", "add", "insert", "replace", "rename", "edit",
            "modify", "change", "switch", "toggle", "check", "test", "verify",
            "validate", "scan", "monitor", "track", "log", "export", "import"
        }
        
        # System action keywords
        self.action_keywords = {
            "file", "folder", "directory", "window", "application", "program",
            "process", "service", "registry", "settings", "configuration",
            "network", "connection", "internet", "wifi", "bluetooth", "usb",
            "drive", "disk", "volume", "partition", "memory", "ram", "cpu",
            "gpu", "screen", "display", "monitor", "mouse", "keyboard",
            "camera", "microphone", "speaker", "audio", "video", "image",
            "picture", "photo", "document", "text", "email", "message", "chat",
            "browser", "website", "url", "link", "download", "upload", "cloud",
            "server", "database", "table", "query", "script", "command",
            "terminal", "console", "shell", "powershell", "batch", "shortcut",
            "icon", "taskbar", "desktop", "wallpaper", "theme", "font",
            "color", "resolution", "brightness", "volume", "mute", "unmute"
        }
        
        # Chat patterns (questions, greetings, conversational phrases)
        self.chat_patterns = [
            r"^(how|what|why|when|where|who|which|can you|could you|would you|will you|are you|is it|do you)",
            r"^(tell me|explain|describe|summarize|help me|show me|let me know)",
        ...
        self.chat_regex_patterns = [re.compile(pattern, re.IGNORECASE) for pattern in self.chat_patterns]
